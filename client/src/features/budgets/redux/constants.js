...
export const EXAMPLES_FETCH_REDDIT_LIST_BEGIN =
  "EXAMPLES_FETCH_REDDIT_LIST_BEGIN";
export const EXAMPLES_FETCH_REDDIT_LIST_SUCCESS =
  "EXAMPLES_FETCH_REDDIT_LIST_SUCCESS";
export const EXAMPLES_FETCH_REDDIT_LIST_FAILURE =
  "EXAMPLES_FETCH_REDDIT_LIST_FAILURE";
export const EXAMPLES_FETCH_REDDIT_LIST_DISMISS_ERROR =
